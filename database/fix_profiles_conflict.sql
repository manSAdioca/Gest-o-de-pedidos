-- Atualiza a Função RPC corrigindo a duplicação no profiles caso já exista um Trigger automático
...
BEGIN
    ...
    -- Correção Suprema: O Supabase costuma ter um "Trigger" oculto que cria o profile automaticamente 
    -- quando criamos um user. Em vez de tentar "Inserir" cegamente e causar conflito, 
    -- usamos o comando de Inserir com Proteção: "Se já existir, apenas ATUALIZE os dados".
